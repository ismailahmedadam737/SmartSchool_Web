...
class AttendancePage extends StatefulWidget {
  ...
  const AttendancePage({super.key, this.userRole = ''});
...
class _AttendancePageState extends State<AttendancePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: (displayList.isNotEmpty && !isUserRole) ? _buildSubmitFab() : null,
    );
  }
    ...
    if (isUserRole) {
      return Container(
        ...
        child: const Row(
          ...
          children: [
            Icon(Icons.visibility, color: Colors.indigo, size: 20),
            SizedBox(width: 8),
            Text(
            ...
            children: [
              ...
              if (!isPresent)
                Padding(
                  ...
                  child: isUserRole
                    ? (s['remarks'] != null && s['remarks'].toString().isNotEmpty)
                      ? Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(child: Text("Sababta: ${s['remarks']}", style: const TextStyle(color: Colors.red, fontSize: 12))),
                            ],
                          ),
                        )
