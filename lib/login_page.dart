...
class _AuthPageState extends State<AuthPage> {
  ...
  Future<void> _handleLogin() async {
    ...
    // Direct master SuperAdmin & Admin login support
    if (user.toLowerCase() == 'superadmin' && (pass == 'superadmin123' || pass == 'admin123' || pass == '123456')) {
      if (!mounted) return;
    ...
    try {
      ...
      // Fallback haddii internetka/server-ka xumaado
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text("Server error ama xiriirka internetka!"),
          backgroundColor: Colors.red,
        ),
      );
    }
